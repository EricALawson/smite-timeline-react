...
// test('stats selector on an empty build returns 20 level events', () => {
//     let selector = makeStatsSelector();
//     let leftGodState = new Build();
//     let events = selector(leftGodState);
//     expect(events.length).toBe(20);
// });
...
//     expect(leftEvents[0].stats.mana).toBe(200);
//     expect(rightEvents[0].stats.mana).toBe(0);
// });